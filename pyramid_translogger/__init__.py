...
# (changing for supporting python3)
...
def translogger_tween(handler, registry):
    ...
    def tween(request):
        ...
        translogger.write_log(environ, method, req_uri, start, response.status, bytes)
        return response
    return tween


def includeme(config):
    config.add_tween("pyramid_translogger.translogger_tween")
